...
var (
	emailAllColumns            = []string{"address", "account_id", "confirmed", "confirmation_sent_at", "confirmation_code"}
	emailColumnsWithoutDefault = []string{"address", "account_id"}
	emailColumnsWithDefault    = []string{"confirmed", "confirmation_sent_at", "confirmation_code"}
