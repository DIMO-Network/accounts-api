...
var (
	accountAllColumns            = []string{"id", "created_at", "country_code", "customer_io_id", "agreed_tos_at", "referral_code", "referred_by", "referred_at"}
	accountColumnsWithoutDefault = []string{"id", "created_at"}
